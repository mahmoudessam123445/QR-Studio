...
(function() {
        ...
        setTimeout(() => {
            try {
                ...
                state.qrInstance = new QRCode(dom.qrcode, {
                    ...
                    // ISO 18004: quiet zone = 4 modules minimum for reliable scanning
                    quietZone: 4,
                    // Logo settings - keep small (max 15% to not interfere with error correction)
                    logo: state.logoImage || undefined,
                    logoWidth: state.logoImage ? Math.floor(size * 0.15) : undefined,
                    logoHeight: state.logoImage ? Math.floor(size * 0.15) : undefined,
                    // White padding around logo + transparent corners for better scanning
                    logoBackgroundColor: '#ffffff',
                    logoBackgroundTransparent: false,
                    logoCornerRadius: 4,
                    // Cross-origin for logo images
    ...
    function downloadPNG() {
        ...
        // EasyQRCodeJS already renders logo in canvas, just download directly
    ...
    function printQR() {
        ...
        printWindow.document.write(`
            ...
            <body style="display:flex;align-items:center;justify-content:center;height:100vh;margin:0;">
                <img src="${canvas.toDataURL('image/png')}" style="max-width:80%;max-height:80%;" />
            </body></html>
        `);
