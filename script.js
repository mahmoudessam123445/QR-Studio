        ...
        setTimeout(() => {
            try {
                ...
                state.qrInstance = new QRCode(dom.qrcode, {
                    ...
                    // Enable UTF-8 mode for Arabic/Unicode support
                    quietZone: 0,
                    logo: state.logoImage || undefined,
                    logoWidth: state.logoImage ? Math.floor(size * 0.2) : undefined,
                    logoHeight: state.logoImage ? Math.floor(size * 0.2) : undefined,
